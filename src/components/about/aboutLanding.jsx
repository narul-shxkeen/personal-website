...
function Landing(){
 return <div className="h-auto w-[100vw] mb-20 flex flex-col md:grid md:grid-cols-4 md:grid-rows-4 md:justify-items-center justify-center gap-4 items-center pt-20 md:px-20 md:pt-24 px-6">

...
function Landing(){
 ...
 <div className="bg-white md:col-span-3 md:row-span-2 h-[100%] w-full flex py-4 md:py-0 pl-4 items-center rounded-xl">
    <h1 className="poppins-bold text-2xl md:text-4xl text-[#b9b9b9] leading-relaxed">Hey there!<br/> I am <br className="md:hidden"/><span className="text-4xl md:text-6xl text-[#578b73] poppins-bold">Vaibhav Shokeen</span></h1>
    </div>

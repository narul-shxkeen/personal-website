...
return <div className="pt-20 md:pt-9"><Particles addParticles={false}/> <div className="bg-slate-50 flex flex-col md:mt-20 mx-4 md:mx-4 rounded-xl py-10 mb-10 md:py-8 px-4 gap-6">
